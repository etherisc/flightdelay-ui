import { formatUnits, getNumber, Signer } from "ethers";
...
import { getStatusProviderSigner } from "../../_utils/chain";
...
export async function GET() {
    ...
    const isReady = riskpoolWalletBalanceSufficient && riskpoolWalletAllowanceSufficient;
