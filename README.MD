...
- `NEXT_PUBLIC_DEPARTURE_DATE_DAYS_MIN`: The minimum number of days in the future for the departure date
- `NEXT_PUBLIC_DEPARTURE_DATE_DAYS_MAX`: The maximum number of days in the future for the departure date
